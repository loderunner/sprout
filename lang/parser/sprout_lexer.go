...
func sproutlexerLexerInit() {
	...
	staticData.RuleNames = []string{
		...
		"T__9", "LET", "IN", "IF", "THEN", "ELSE", "TRUE", "FALSE", "FUN", "ARROW",
		"EQUALS", "INT", "IDENT", "COMPOP", "WS",
	}
	...
	staticData.serializedATN = []int32{
		...
		7, 1, 7, 1, 8, 1, 8, 1, 9, 1, 9, 1, 10, 1, 10, 1, 10, 1, 10, 1, 11, 1,
		11, 1, 11, 1, 12, 1, 12, 1, 12, 1, 13, 1, 13, 1, 13, 1, 13, 1, 13, 1, 14,
		1, 14, 1, 14, 1, 14, 1, 14, 1, 15, 1, 15, 1, 15, 1, 15, 1, 15, 1, 16, 1,
		16, 1, 16, 1, 16, 1, 16, 1, 16, 1, 17, 1, 17, 1, 17, 1, 17, 1, 18, 1, 18,
		1, 18, 1, 19, 1, 19, 1, 20, 1, 20, 1, 20, 5, 20, 115, 8, 20, 10, 20, 12,
		...
		0, 0, 0, 7, 55, 1, 0, 0, 0, 9, 58, 1, 0, 0, 0, 11, 61, 1, 0, 0, 0, 13,
		63, 1, 0, 0, 0, 15, 65, 1, 0, 0, 0, 17, 67, 1, 0, 0, 0, 19, 69, 1, 0, 0,
		0, 21, 71, 1, 0, 0, 0, 23, 75, 1, 0, 0, 0, 25, 78, 1, 0, 0, 0, 27, 81,
		1, 0, 0, 0, 29, 86, 1, 0, 0, 0, 31, 91, 1, 0, 0, 0, 33, 96, 1, 0, 0, 0,
		35, 102, 1, 0, 0, 0, 37, 106, 1, 0, 0, 0, 39, 109, 1, 0, 0, 0, 41, 119,
		1, 0, 0, 0, 43, 121, 1, 0, 0, 0, 45, 137, 1, 0, 0, 0, 47, 140, 1, 0, 0,
		0, 49, 50, 5, 40, 0, 0, 50, 2, 1, 0, 0, 0, 51, 52, 5, 58, 0, 0, 52, 4,
		1, 0, 0, 0, 53, 54, 5, 41, 0, 0, 54, 6, 1, 0, 0, 0, 55, 56, 5, 124, 0,
		0, 56, 57, 5, 124, 0, 0, 57, 8, 1, 0, 0, 0, 58, 59, 5, 38, 0, 0, 59, 60,
		5, 38, 0, 0, 60, 10, 1, 0, 0, 0, 61, 62, 5, 43, 0, 0, 62, 12, 1, 0, 0,
		0, 63, 64, 5, 45, 0, 0, 64, 14, 1, 0, 0, 0, 65, 66, 5, 42, 0, 0, 66, 16,
		1, 0, 0, 0, 67, 68, 5, 47, 0, 0, 68, 18, 1, 0, 0, 0, 69, 70, 5, 33, 0,
		0, 70, 20, 1, 0, 0, 0, 71, 72, 5, 108, 0, 0, 72, 73, 5, 101, 0, 0, 73,
		74, 5, 116, 0, 0, 74, 22, 1, 0, 0, 0, 75, 76, 5, 105, 0, 0, 76, 77, 5,
		110, 0, 0, 77, 24, 1, 0, 0, 0, 78, 79, 5, 105, 0, 0, 79, 80, 5, 102, 0,
		0, 80, 26, 1, 0, 0, 0, 81, 82, 5, 116, 0, 0, 82, 83, 5, 104, 0, 0, 83,
		84, 5, 101, 0, 0, 84, 85, 5, 110, 0, 0, 85, 28, 1, 0, 0, 0, 86, 87, 5,
		101, 0, 0, 87, 88, 5, 108, 0, 0, 88, 89, 5, 115, 0, 0, 89, 90, 5, 101,
		0, 0, 90, 30, 1, 0, 0, 0, 91, 92, 5, 116, 0, 0, 92, 93, 5, 114, 0, 0, 93,
		94, 5, 117, 0, 0, 94, 95, 5, 101, 0, 0, 95, 32, 1, 0, 0, 0, 96, 97, 5,
		102, 0, 0, 97, 98, 5, 97, 0, 0, 98, 99, 5, 108, 0, 0, 99, 100, 5, 115,
		0, 0, 100, 101, 5, 101, 0, 0, 101, 34, 1, 0, 0, 0, 102, 103, 5, 102, 0,
		0, 103, 104, 5, 117, 0, 0, 104, 105, 5, 110, 0, 0, 105, 36, 1, 0, 0, 0,
		106, 107, 5, 45, 0, 0, 107, 108, 5, 62, 0, 0, 108, 38, 1, 0, 0, 0, 109,
		110, 5, 61, 0, 0, 110, 40, 1, 0, 0, 0, 111, 120, 5, 48, 0, 0, 112, 116,
		7, 0, 0, 0, 113, 115, 7, 1, 0, 0, 114, 113, 1, 0, 0, 0, 115, 118, 1, 0,
		0, 0, 116, 114, 1, 0, 0, 0, 116, 117, 1, 0, 0, 0, 117, 120, 1, 0, 0, 0,
		118, 116, 1, 0, 0, 0, 119, 111, 1, 0, 0, 0, 119, 112, 1, 0, 0, 0, 120,
		42, 1, 0, 0, 0, 121, 125, 7, 2, 0, 0, 122, 124, 7, 3, 0, 0, 123, 122, 1,
		0, 0, 0, 124, 127, 1, 0, 0, 0, 125, 123, 1, 0, 0, 0, 125, 126, 1, 0, 0,
		0, 126, 44, 1, 0, 0, 0, 127, 125, 1, 0, 0, 0, 128, 129, 5, 61, 0, 0, 129,
		138, 5, 61, 0, 0, 130, 131, 5, 33, 0, 0, 131, 138, 5, 61, 0, 0, 132, 133,
		5, 60, 0, 0, 133, 138, 5, 61, 0, 0, 134, 135, 5, 62, 0, 0, 135, 138, 5,
		61, 0, 0, 136, 138, 7, 4, 0, 0, 137, 128, 1, 0, 0, 0, 137, 130, 1, 0, 0,
		0, 137, 132, 1, 0, 0, 0, 137, 134, 1, 0, 0, 0, 137, 136, 1, 0, 0, 0, 138,
